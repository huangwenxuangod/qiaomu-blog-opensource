      ...
      <main className="page-main mx-auto w-full px-4 sm:px-6 flex-1 py-8 sm:py-12">
        {searchIndexable && (() => {
          ...
          const jsonLd = {
            ...
            description: post.description || '',
            image: ogImage,
            author: { '@type': 'Person', name: '文轩', url: 'https://x.com/hungxun254458' },
            publisher: { '@type': 'Organization', name: '文轩', url: baseUrl, logo: { '@type': 'ImageObject', url: `${baseUrl}/icon-512.png` } },
